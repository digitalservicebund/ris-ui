...
const menu: MenuPassThroughOptions = {
  ...
  item: ({ context }) => {
    const base = tw`relative h-48 pr-12 pl-16 after:absolute after:right-16 after:-bottom-1 after:left-16 after:border-b after:border-gray-300 after:content-[''] last:after:border-b-0 hover:bg-blue-100`;
