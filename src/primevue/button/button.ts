...
const button: ButtonPassThroughOptions = {
  root: ({ props, instance }) => {
    ...
    const secondary = tw`border-2 border-blue-800 bg-white text-blue-800 hover:bg-blue-200 focus:bg-blue-200 active:bg-blue-400 disabled:border-blue-500 disabled:text-blue-500 disabled:hover:bg-white`;

    const danger = tw`border-2 border-red-800 bg-white text-red-800 hover:bg-red-100 focus:bg-red-100 focus:outline-red-800 active:border-red-800 active:bg-red-400 disabled:border-red-500 disabled:text-red-500 disabled:hover:bg-white`;
    ...
    const primaryText = tw`border-2 border-transparent bg-transparent text-blue-800 underline hover:border-gray-500 hover:bg-white focus:border-gray-500 active:border-blue-600 active:bg-blue-400 disabled:bg-transparent disabled:text-gray-500`;
