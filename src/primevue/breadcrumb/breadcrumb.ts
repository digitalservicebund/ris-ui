...
const breadcrumb: BreadcrumbPassThroughOptions = {
  ...
  itemLink: {
    class: tw`inline-flex cursor-pointer items-center text-blue-800 underline-offset-[3px] hover:underline focus:outline-4 focus:outline-offset-4 focus:outline-blue-800`,
  },
  separator: {
